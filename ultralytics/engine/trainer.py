...
class BaseTrainer:
    ...
    def _do_train(self, world_size=1):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in pbar:
                ...
                # l1_lambda = 0.2*1e-2 * (1 - 0.9 * epoch / self.epochs)
    ...
    def build_optimizer(self, model, name='auto', lr=0.001, momentum=0.987, decay=1e-5, iterations=1e5):
        """
        ...
        if name in ('Adam', 'Adamax', 'AdamW', 'NAdam', 'RAdam'):
            ...
            raise NotImplementedError(
                ...
                f'[Adam, AdamW, NAdam, RAdam, RMSProp, SGD, auto, Lion].'
